...
but_4=Button(top,text=' 文檔審閲 ',bg='#86775f',fg='white',bd=1,command=mvn_taang_lhvmq_lot)
...
#文档审阅
lab_41=Label(top,text=' 文檔審閲 mən ta̠ŋ l̥əmʔ lot')
...
but_42=Button(top,text='審 閲',bg='#86775f',fg='white',bd=1,command=lhvmq_lot)
...
ent_42=Entry(top,width=8,textvariable='n3')
ent_42.config(font=('宋体',14))

lab_44=Label(top,text='A 類佔比')
lab_44.config(font=('宋体',14))

ent_43=Entry(top,width=8,textvariable='n4')
